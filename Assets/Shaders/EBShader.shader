...
Shader "Unlit/EBShader"
{
	Properties
	{
		...
		_DistortX("X Mode", int) = 0
		_DistortY("Y Mode", int) = 0

		[Space(10)]

		_AmplitudeX("X: Amplitude", float) = 16.0
		_FrequencyX("X: Frequency", float) = 0.1
		_CompressionX("X: Compression", float) = 1.0
		_TimeScalingX("X: Time Scaling", float) = 32

		[Space(10)]

		_AmplitudeY("Y: Amplitude", float) = 16.0
		_FrequencyY("Y: Frequency", float) = 0.1
		_CompressionY("Y: Compression", float) = 1.0
		_TimeScalingY("Y: Time Scaling", float) = 32
	}
	SubShader
	{
		// No culling or depth
